...
const MOCK_DB: NewsItem[] = [
  ...
  { id: 6, title: "กิจกรรมจิตอาสาบริจาคโลหิตเนื่องในวันสถาปนา", date: "19 พฤศจิกายน 2026", image_src: "/amlo5.jpg", description: "เชิญชวนเจ้าหน้าที่และประชาชนร่วมบริจาคโลหิตต่อชีวิตเพื่อนมนุษย์", content: "<h3>รายละเอียดกิจกรรม</h3><p>ร่วมทำความดีบริจาคโลหิต ณ สภากาชาดไทย...</p>" },
...
// ==========================================
// 2. ข้อมูลจำลอง - ข่าวประชาสัมพันธ์ (Advertise/PR) : 20 รายการ
// ==========================================
const MOCK_PR_DB: NewsItem[] = [
  ...
  { id: 2, title: "ประกาศผลการจัดซื้อจัดจ้าง (ไตรมาสที่ 2)", date: "28 เมษายน 2026", image_src: "/amlo1.jpg", description: "สรุปผลการดำเนินการจัดซื้อจัดจ้างประจำปีงบประมาณ 2569", content: "<h3>รายงานสรุปการจัดซื้อจัดจ้าง</h3><p>รายการที่สำคัญประจำเดือนเมษายน...</p>" },
  ...
  { id: 4, title: "เชิญชวนร่วมตอบแบบสอบถามความพึงพอใจประจำปี", date: "20 ตุลาคม 2026", image_src: "/amlo4.jpg", description: "ร่วมประเมินเพื่อพัฒนาคุณภาพการให้บริการ", content: "<h3>ช่วยเราพัฒนา!</h3><p>ความเห็นของท่านมีค่าต่อเราอย่างยิ่ง...</p>" },
  { id: 5, title: "ปฏิทินการจัดงานขายทอดตลาดทรัพย์สิน ประจำปี 2569", date: "15 ธันวาคม 2026", image_src: "/amlo5.jpg", description: "อัปเดตกำหนดการและสถานที่จัดงานตลอดทั้งปี", content: "<h3>ตารางประมูลปี 2569</h3><ul><li>ครั้งที่ 1: มกราคม</li><li>ครั้งที่ 2: เมษายน</li></ul>" },
  { id: 6, title: "คู่มือการใช้งานระบบรายงานธุรกรรม (ฉบับปรับปรุง)", date: "10 มีนาคม 2026", image_src: "/amlo3.jpg", description: "อัปเดตคู่มือสำหรับผู้ประกอบวิชาชีพและสถาบันการเงิน", content: "<h3>ดาวน์โหลดคู่มือ</h3><p>โปรดคลิกดาวน์โหลดตามหัวข้อ...</p>" },
  { id: 7, title: "รายงานประจำปี (Annual Report) 2568", date: "5 กุมภาพันธ์ 2026", image_src: "/amlo1.jpg", description: "เผยแพร่ผลการดำเนินงานและสถิติการยึดอายัดทรัพย์สิน", content: "<h3>รายงานประจำปี</h3><p>สามารถดาวน์โหลดรายงานฉบับเต็มได้แล้ววันนี้...</p>" },
