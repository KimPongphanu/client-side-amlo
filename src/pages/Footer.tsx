      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <div className="flex flex-col gap-4 text-left">
            <img src="/Logo.png" alt="โลโก้ ปปง." className="w-[90px] h-[90px] object-contain" />
            
            <div>
              {/* ซ่อน <br/> ในมือถือ แต่โชว์ในคอม เพื่อตัดบรรทัดให้สวยงาม */}
              <h3 className="text-white text-xl md:text-2xl font-bold leading-snug">
                สำนักงานกองข่าวกรองทางการเงิน <br className="hidden lg:block" /> สำนักงาน ปปง.
              </h3>
              <p className="text-sm text-slate-400 mt-1">Anti-Money Laundering Office (AMLO)</p>
            </div>
            ...
            <div className="pt-2">
              <Link to="#" className="inline-block px-6 py-2 rounded-full border border-slate-600 text-slate-300 hover:bg-white hover:text-slate-900 transition-colors font-medium text-sm">
                ติดต่อเรา
              </Link>
            </div>
          </div>
          ...
          <div className="w-full h-full min-h-[200px] md:min-h-[200px]">
            <div className="w-full h-full rounded-2xl overflow-hidden shadow-xl border border-slate-700/50 bg-slate-800">
              <iframe 
